...
Route::post('/{nickname}/{category}/{id_item}', [ItemController::class, 'store'])->middleware(['is_creator', 'has_main_page'])->name('item_store'); // feito com sucesso!
...
Route::patch('/{nickname}/{category}/{id_item}', [ItemController::class, 'update'])->middleware(['is_creator', 'has_main_page'])->name('item_update'); // feito com sucesso!
Route::delete('/{nickname}/{category}/{id_item}', [ItemController::class, 'destroy'])->middleware(['is_creator', 'has_main_page'])->name('item_destroy'); // feito com sucesso!
